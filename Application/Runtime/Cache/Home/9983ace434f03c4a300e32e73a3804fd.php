...
<?php if(is_array($detail)): foreach($detail as $key=>$v): ?><div class="pageHead"></div>	
	<div id="case_detail_head">
		<div class="container">
			...
			<div class="headImg">
				<?php $__FOR_START_1109675662__=1;$__FOR_END_1109675662__=7;for($i=$__FOR_START_1109675662__;$i < $__FOR_END_1109675662__;$i+=1){ ?><img src="/Public/Home/default/Ftp/<?php echo ($detail[0]['ftp_url']); ?>/images/<?php echo ($i); ?>.jpg" alt="<?php echo ($v["title"]); ?>"><?php } ?>
			</div>
		</div>
	</div>
	<div id="content">
	<?php $__FOR_START_721707526__=7;$__FOR_END_721707526__=37;for($i=$__FOR_START_721707526__;$i < $__FOR_END_721707526__;$i+=1){ ?><img src="/Public/Home/default/Ftp/<?php echo ($detail[0]['ftp_url']); ?>/images/<?php echo ($i); ?>.jpg" alt="<?php echo ($v["title"]); ?>"><?php } ?>
