...
<?php if(is_array($detail)): foreach($detail as $key=>$v): ?><div class="pageHead"></div>	
	...
	<div id="content">
	<?php $__FOR_START_448037581__=2;$__FOR_END_448037581__=8;for($i=$__FOR_START_448037581__;$i < $__FOR_END_448037581__;$i+=1){ ?><img src="/Public/Home/default/Ftp/<?php echo ($detail[0]['ftp_url']); ?>/images/<?php echo ($i); ?>.jpg" alt="<?php echo ($v["title"]); ?>"><?php } ?>
