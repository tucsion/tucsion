...
<head>
	...
	<title>加入我们_图森品牌 - 官方网站</title>
	<meta name="keywords" content="关于关键字">
	<meta name="description" content="关于描述">
...
<body>
	...
	<div id="banner">
		<div class="text">
			<h4>期待你的加入</h4>
			<p>共同的归属感、认同感、使命感，产生强大的凝聚力热情、专业、执着、正直、才华洋溢——是为图森的团队气质</p>
		</div>
		<img src="/Public/Home/default/images/about_join_banner.jpg" alt="加入图森" />
	</div>
	<!-- 招聘列表 -->
	<div class="join container">
		<ul class="join_ul">
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
				<span class="title"><?php echo ($v["title"]); ?><i>招聘人数<?php echo ($v["num"]); ?>人</i></span>
				<dl>
					<dt>招聘人数<?php echo ($v["num"]); ?>人</dt>
					<dd>
						<p>职位描述：</p>
				...
				<a class="btn" href="#">应聘此职位</a>
			</li><?php endforeach; endif; ?>
		</ul>
		<div style="clear:both;"></div>
		<div class="join_mail">
			<p>请发送简历及作品至<a href="mailto:admin@tucsion.com">admin@tucsion.com</a>，邮件主题为：“职位+姓名”</p>
			<a href="#" class="btn">我要加入</a>
		</div>
	</div>
