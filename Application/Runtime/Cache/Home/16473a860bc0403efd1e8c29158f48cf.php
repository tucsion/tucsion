...
<head>
	...
	<title>联系图森_图森品牌 - 官方网站</title>
	<meta name="keywords" content="图森联系方式,联系图森">
	<meta name="description" content="您可以通过本页联系到图森工作人员为您解疑答惑,欢迎联系我们">
	<link rel="stylesheet" href="/Public/Home/default/css/base.css">
    <link rel="stylesheet" href="/Public/Home/default/css/common.css">
    
	<link rel="stylesheet" href="/Public/Home/default/css/contact.css">
...
<body>
	...
	<div id="contact" class="container">
		<div class="contact">
			...
			<p class="subtitle">
				如果您有新的项目想与我们讨论，请给我们发送邮件或者填写下面这个表单。欢迎发送合作邮件至：<a href="mailto:admin@tucsion.com">admin@tucsion.com</a>
			</p>
			<form action="/contact/" method="post">
				<dl>
					<dd>
						<input type="text" name="name" />
						<span class="field">您的姓名：</span><i>*</i>
					</dd>
					<dd>
						<input type="text" name="phone" />
						<span class="field">联系手机：</span><i>*</i>
					</dd>
					<dd>
						<input type="text" name="email" />
						<span class="field">您的邮箱：</span><i>*</i>
					</dd>
					<dd class="textarea">
						<textarea name="content"></textarea>
						<span class="field">合作需求：</span><i>*</i>
					</dd>
					<input type="submit" class="btn" value="完成并发送" />
				</dl>
			</form>

			<h4 class="title">我们在这里</h4>
			<p class="subtitle">
				通过实时的动态地图，您可以清楚的看到我们北京公司的所在地，我们随时欢迎您的到来。
			</p>
			<div class="map">
				<img src="/Public/Home/default/images/map.jpg" alt="图森地址">
			</div>
		</div>
	</div>
