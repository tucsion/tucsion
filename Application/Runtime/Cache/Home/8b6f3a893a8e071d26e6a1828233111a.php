...
<?php if(is_array($detail)): foreach($detail as $key=>$v): ?><div class="pageHead"></div>	
	...
	<?php $__FOR_START_57837289__=1;$__FOR_END_57837289__=32;for($i=$__FOR_START_57837289__;$i < $__FOR_END_57837289__;$i+=1){ ?><img src="/Public/Home/default/Ftp/<?php echo ($detail[0]['ftp_url']); ?>/images/<?php echo ($i); ?>.jpg" alt="<?php echo ($v["title"]); ?>"><?php } ?>
