...
<head>
	...
	<title>案例_图森品牌 - 官方网站</title>
	<meta name="keywords" content="案例关键字">
	<meta name="description" content="案例描述">
...
<body>
	...
	<div class="container">
		<ul class="subNav">
			<li><a class="active" href="/case/">全部</a></li>
		<?php if(is_array($subNavs)): $i = 0; $__LIST__ = $subNavs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$subNavs): $mod = ($i % 2 );++$i;?><li><a href="/<?php echo ($subNavs["dir"]); ?>/"><?php echo ($subNavs["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
		<ul class="case-list">
		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li>
				<a class="img" href="/<?php echo ($vo["fid_dir"]); ?>/<?php echo ($vo["id"]); ?>.html"><img src="<?php echo ($vo["thumbnail"]); ?>" alt="<?php echo ($vo["name"]); ?>"></a>
				<a class="title" href="/<?php echo ($vo["fid_dir"]); ?>/<?php echo ($vo["id"]); ?>.html"><?php echo ($vo["name"]); ?></a>
				<p class="info"><?php echo ($vo["sub_name"]); ?></p>
			</li><?php endforeach; endif; ?>
		</ul>
		<div class="more">
			<a href='###' id='more'>更多精彩</a>
		</div>
	</div>
