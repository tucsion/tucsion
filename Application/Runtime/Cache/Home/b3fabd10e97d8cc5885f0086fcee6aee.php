...
<head>
	...
	<title><?php echo ($detail[0][title]); ?>_图森品牌 - 官方网站</title>
...
<body>
	...
	<div class="container details">
		<?php if(is_array($detail)): foreach($detail as $key=>$v): ?><div class="detail">
		 	<h2 class="title"><?php echo ($v["title"]); ?></h2>
		 	<p class="info"><a href="/<?php echo ($v["cate_dir"]); ?>/"><?php echo ($v["cate_name"]); ?></a> | <span><?php echo (date('Y.m.d',$v["post_time"])); ?></span></p>
		 	<div class="content">
		 		<?php echo ($v["content"]); ?>
		 	</div>
		</div><?php endforeach; endif; ?>
	</div>
	<div class="more-news picScroll-left">
		<p class="title">更多新闻</p>
		<div class="ul_box bd">
