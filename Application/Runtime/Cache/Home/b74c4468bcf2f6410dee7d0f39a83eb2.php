...
<?php if(is_array($detail)): foreach($detail as $key=>$v): ?><div class="pageHead"></div>	
	...
	<div id="content">
		<div class="headImg">
			<?php $__FOR_START_995312382__=1;$__FOR_END_995312382__=6;for($i=$__FOR_START_995312382__;$i < $__FOR_END_995312382__;$i+=1){ ?><img src="/Public/Home/default/Ftp/<?php echo ($detail[0]['ftp_url']); ?>/images/<?php echo ($i); ?>.jpg" alt="<?php echo ($v["title"]); ?>"><?php } ?>
		</div>
	<?php $__FOR_START_1266166868__=6;$__FOR_END_1266166868__=36;for($i=$__FOR_START_1266166868__;$i < $__FOR_END_1266166868__;$i+=1){ ?><img src="/Public/Home/default/Ftp/<?php echo ($detail[0]['ftp_url']); ?>/images/<?php echo ($i); ?>.jpg" alt="<?php echo ($v["title"]); ?>"><?php } ?>
