...
<?php if(is_array($detail)): foreach($detail as $key=>$v): ?><div id="case_detail_head">
		<div class="container">
		...
		<div class="container">
			<ul class="banner">
				<?php if(is_array($v["banner"])): foreach($v["banner"] as $key=>$vo): ?><li><img src="<?php echo ($vo); ?>" alt=""></li><?php endforeach; endif; ?>
			</ul>
		</div>
	</div>
	<div class="case_detail_content container">
		<?php echo ($v["content"]); ?>
	</div>
